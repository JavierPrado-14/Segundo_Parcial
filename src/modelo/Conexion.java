...
public class Conexion {
    ...
    public void abrir_conexion(){
        try{
           ...
           // JOptionPane.showMessageDialog(null, "Conexion con Exito....","Exito",JOptionPane.INFORMATION_MESSAGE);
            
        }catch(HeadlessException | ClassNotFoundException | SQLException ex){
        System.out.println("Error al realizar conexion"+ex.getMessage());
        }
    }
